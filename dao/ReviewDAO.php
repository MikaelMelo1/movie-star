<?php
  ...
  class ReviewDao implements ReviewDAOInterface {
    ...
    public function create(Review $review) {
      ...
      $stmt->bindValue(":rating", $review->rating);
      $stmt->bindValue(":review", $review->review);
      $stmt->bindValue(":movies_id", $review->movies_id);
      $stmt->bindValue(":users_id", $review->users_id);
